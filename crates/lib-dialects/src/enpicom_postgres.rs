...
pub fn raw_dialect() -> Dialect {
    let mut enpicom_postgres = ansi::raw_dialect();
    enpicom_postgres.name = DialectKind::EnpicomPostgres;

    enpicom_postgres.patch_lexer_matchers(vec![
        ...
        Matcher::regex("end_bracket", r"([)]⚟☢)|[)]", SyntaxKind::EndBracket),
        Matcher::regex("word", "[0-9a-zA-Z_🫸🫷💣]+", SyntaxKind::Word),
    ]);

    enpicom_postgres.insert_lexer_matchers(
        vec![
            Matcher::regex(
                "dynamic_start",
                r"☢⚞[a-z0-9_]+",
                SyntaxKind::DynamicQueryStart,
            ),
            Matcher::regex(
                "enpicom_identifier",
                r"[$][a-z0-9_]+",
                SyntaxKind::EnpicomIdentifier,
            ),
        ],
        "like_operator",
    );
    ...
    enpicom_postgres.insert_lexer_matchers(vec![
        Matcher::regex(
    ...
    // Add datetime units
    enpicom_postgres.sets_mut("datetime_units").extend([
        "CENTURY",
        "DECADE",
        "DOW",
        "DOY",
    ...
    enpicom_postgres.sets_mut("bare_functions").extend([
        "CURRENT_TIMESTAMP",
        "CURRENT_TIME",
        "CURRENT_DATE",
        "LOCALTIME",
    ...
    enpicom_postgres.sets_mut("date_part_function_name").clear();
    ...
    enpicom_postgres.add(
        [
            ...
            (
                "EnpicomSegment".into(),
                NodeMatcher::new(
                    SyntaxKind::EnpicomSegment,
                    Sequence::new(vec_of_erased![
                        TypedParser::new(
                            SyntaxKind::EnpicomIdentifier,
                            SyntaxKind::EnpicomIdentifier,
                        ),
                        Ref::new("EnpicomSubQuerySegment").optional(),
                    ])
                    .to_matchable(),
                )
                .to_matchable()
            ...
            (
                ...
                SegmentGenerator::new(|dialect| {
                    ...
                    let pattern = reserved_keywords.iter().filter(|k| *k != &"USER").join("|");

                    RegexParser::new(&pattern, SyntaxKind::Keyword).to_matchable()
                })
                .into(),
            ),
            (
                "BaseNakedIdentifierSegment".into(),
                SegmentGenerator::new(|dialect| {
                    // Generate the anti-template from the set of reserved keywords
                    let reserved_keywords = dialect.sets("reserved_keywords");
            ...
            (
                ...
                one_of(vec_of_erased![
                    ...
                    Ref::new("EnpicomSegment"),
                ])
                .config(|this| this.exclude = Some(Ref::new("KeywordSegment").to_matchable()))
                .to_matchable()
                .into(),
            ),
            (
    ...
    enpicom_postgres.add([(
        "DynamicQueryStartSegment".into(),
        TypedParser::new(SyntaxKind::DynamicQueryStart, SyntaxKind::FunctionName)
            .to_matchable()
            .into(),
    )]);
    ...
    enpicom_postgres.add([
        (
            "DynamicQuerySegment".into(),
            NodeMatcher::new(
                SyntaxKind::DynamicQuery,
                Sequence::new(vec_of_erased![
                    Ref::new("DynamicQueryStartSegment"),
        ...
        (
            "EnpicomSubQuerySegment".into(),
            NodeMatcher::new(
                SyntaxKind::EnpicomSubQuery,
                Sequence::new(vec_of_erased![
                    Ref::new("StartCurlyBracketSegment"),
                    Ref::new("NakedIdentifierSegment"),
                    ...
                    Ref::new("EndCurlyBracketSegment")
                ])
                .to_matchable(),
            )
            .to_matchable()
    ...
    enpicom_postgres.replace_grammar(
    ...
    enpicom_postgres.replace_grammar("ArrayTypeSegment", Ref::keyword("ARRAY").to_matchable());
    ...
    enpicom_postgres.replace_grammar(
        ...
        .config(|this| {
            this.terminators = vec_of_erased![Ref::new("SelectClauseTerminatorGrammar")];
            // this.parse_mode(ParseMode::GreedyOnceStarted);
        })
        .to_matchable(),
    );

    let base_select = vec_of_erased![
        one_of(vec_of_erased![
            Ref::new("DynamicQuerySegment"),
            Sequence::new(vec_of_erased![
        ...
        Ref::new("IntoClauseSegment").optional(),
    ...
    let mut unordered_select = base_select.clone();
    unordered_select.extend(vec_of_erased![Ref::new("NamedWindowSegment").optional()]);

    enpicom_postgres.replace_grammar(
        "UnorderedSelectStatementSegment",
        Sequence::new(unordered_select)
    ...
    let mut ordered_select = base_select.clone();
    ordered_select.extend(vec_of_erased![
    ...
    enpicom_postgres.replace_grammar(
        ...
        Sequence::new(vec_of_erased![
            ...
            .config(|this| {
                ...
                this.terminators =
                    vec_of_erased![Ref::keyword("RETURNING"), Ref::keyword("QUALIFY")];
            }),
            Ref::new("QualifyClauseSegment").optional(),
            Sequence::new(vec_of_erased![
                Ref::keyword("ON"),
